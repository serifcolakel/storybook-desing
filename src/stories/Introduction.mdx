...
Storybook helps you build UI components in isolation from your app's business logic, data, and context. This makes building stunning UIs larger than a single component easier and faster than ever before. That's why Storybook has become the industry standard for developing UI components.
...
### Storybook has a lot of advantages.

Here are the top 3:

- **Develop components in isolation** - You can develop entire UIs without needing to start up a complex dev stack, force certain data into your database, or navigate to various screens in your app. This makes UI development fast.

- **Re-use components to build pages** - You can reuse components to build pages and features. This makes it easy to build consistent UIs and ensure that your team is using the same components across projects.

- **Document components** - You can document components with notes and an embedded version of your Storybook. This makes it easy for your team to see how to use components and shows off your UI components to designers and stakeholders.

### Simple example stories to get you started.

- [Button](?path=/story/example-button--primary)
- [Checkbox](?path=/docs/example-checkbox--docs)
- [Tooltip](?path=/story/example-tooltip--docs)
- [ImageUpload](?path=/story/example-imageupload--docs)
